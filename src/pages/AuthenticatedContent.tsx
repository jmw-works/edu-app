...
>
  <Flex direction="row" justifyContent="space-between" alignItems="center">
    ...
    {/* Motivational text (moved to the left) */}
    ...
    {/* XP, Badge, Streak section (moved to the right) */}
  ...
  <Flex direction="column" alignItems="center" gap="xs">
    ...
    <Text fontSize="small" style={{ color: '#ffffff' }}>Experience</Text>
  </Flex>
  <Flex direction="column" alignItems="center" gap="xs">
    ...
    <Text fontSize="small" style={{ color: '#ffffff' }}>Achievements</Text>
  </Flex>
  <Flex direction="column" alignItems="center" gap="xs">
    ...
    <Text fontSize="small" style={{ color: '#ffffff' }}>Consistency</Text>
  </Flex>
</Flex>
